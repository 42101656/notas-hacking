...
-rw-r-----  1 bandit14 bandit13 1.7K Oct  5 06:19 sshkey.private
...
```
## Notas adicionales
* La opcion -i del comando ssh especifica un archivo desde el cual se lee la clave de identidad (clave privada) para la autenticación de clave pública.
## Referencias
