...
```
kali@kali:~/Documents/picoCTF/retos-crypto-parte-1$ nc jupiter.challenges.picoctf.org 5726
Encrypted message:
...
```
2. Copiar todo el texto, con excepción del primer renglón.
3. Ir a https://www.guballa.de/vigenere-solver, pegar el texto anterior y darle click a Break Cipher.
4. La bandera es :
